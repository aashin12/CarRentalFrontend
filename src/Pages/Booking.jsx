              ...
              <div className="col-md-3 col-sm-6 mb-4" key={index}>
                <div className="border border-light p-3 rounded-4 shadow bbb text-white" style={{ backgroundColor: '#1e2a38' }}>
                  <div className="text-center mb-3">
                    <img src={booking.carImage || 'https://cdn.pixabay.com/photo/2012/04/12/23/47/car-30984_1280.png'} alt={booking.carName} className="img-fluid rounded-3" style={{ maxHeight: '150px', objectFit: 'cover' }} />
                  </div>
